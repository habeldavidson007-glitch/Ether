"""
Local LEANN Adapter (local_leann_adapter.py)
--------------------------------------------
...
class LocalLeannIndex:
    ...
    def build_index(self):
        ...
        print(f"[LEANN] Building compressed index for {self.project_root}...")
        self.chunks.clear()
        ...
        print(f"[LEANN] Indexed {files_processed} files, {len(self.chunks)} chunks")
        print(f"[LEANN] Vocabulary: {self.vocabulary_size} unique tokens")
        print(f"[LEANN] Total tokens: {self.total_tokens}")
    ...
    def _index_file(self, file_path: Path, all_tokens: Set[str]):
        ...
        try:
            ...
            print(f"[LEANN] Skip {file_path}: {e}")
            return
    ...
    def save_index(self, path: str):
        ...
        with open(path, 'wb') as f:
            pickle.dump(data, f)
        print(f"[LEANN] Index saved to {path}")
    ...
    def load_index(self, path: str):
        ...
        print(f"[LEANN] Index loaded from {path}")
        return True
