"""
Feedback Trainer (feedback_trainer.py)
--------------------------------------
...
class FeedbackTrainer:
    ...
    def _load_data(self):
        ...
        if self.feedback_file.exists():
            try:
                ...
                print(f"[FeedbackTrainer] Loaded {len(self.feedback_history)} feedback entries")
            except Exception as e:
                print(f"[FeedbackTrainer] Error loading data: {e}")
                
        if self.patterns_file.exists():
            try:
                with open(self.patterns_file, 'r') as f:
                    self.learned_patterns = defaultdict(list, json.load(f))
                print(f"[FeedbackTrainer] Loaded {len(self.learned_patterns)} pattern categories")
            except Exception as e:
                print(f"[FeedbackTrainer] Error loading patterns: {e}")
    ...
    def _save_data(self):
        ...
        try:
            ...
            print(f"[FeedbackTrainer] Error saving data: {e}")
    ...
    def record_feedback(self, query: str, original_code: str, suggested_fix: str,
        ...
        print(f"[FeedbackTrainer] Recorded {user_feedback} feedback (Success Rate: {self.success_rate:.1f}%)")
        return entry_id
    ...
    def export_report(self, output_path: str):
        ...
        print(f"[FeedbackTrainer] Report exported to {output_path}")
